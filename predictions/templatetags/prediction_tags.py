...
def check_prediction_warning(context) -> bool:
    """
    Check if there is a prediction warning for the current user's context.
    Takes a context parameter and returns a boolean indicating whether there should be a prediction warning displayed.
    """
